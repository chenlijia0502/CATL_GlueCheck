...
class WorkListWidget(QtWidgets.QWidget):
    def __init__(self, h_parent):
        super(WorkListWidget, self).__init__()
    ...
    def initUI(self):
        ...
        TableWidget=QtWidgets.QTableWidget(100,5)
        ...
        TableWidget.setHorizontalHeaderLabels(['班次', '产品ID（Barcode）','检测时间','检测结果信息', 'OK/NG'])
