...
class HARDWAREBASEMSG:
    ...
    MSG_DUIWEI_JIANG = [0x01, 0x03, 0x04, 0x01, 0x00, 0x00, 0x00]

    MSG_DUIWEI_SHENG = [0x01, 0x03, 0x04, 0x02, 0x00, 0x00, 0x00]
    ...
    MSG_LEFT_DUIWEI_DAOWEI = [0x01, 0x02, 0x01, 0x10, 0x00, 0x00, 0x00]

    MSG_RIGHT_RIGHT_DAOWEI = [0x01, 0x02, 0x01, 0x12, 0x00, 0x00, 0x00]
    ...
    MSG_GUANGSHAN = ['01020136000000', '01020137000000'] #光栅信号，当接收到这个要做出反应

    MSG_JITINGMENKONG = '000000000000'
    ...
    MSG_CONTROL_ALARM = [0x01, 0x06, 0x01, 0x00, 0x00, 0x00, 0x00] #2021.12.31 待测试
