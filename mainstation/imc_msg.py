...
# MSG_OPENCAMERA2SAVEIMG = 503 #打开相机保存图片
#
# MSG_CLOSECAMERA2SAVEIMG = 504
...
list_mainwindow_module = [MSG_START_CHECK_IS_READY, MSG_CAMERA_IS_READY, MSG_CHECK_RESULT, MSG_BUILD_MODEL, MSG_BUILD_MODEL_SECOND, MSG_DOT_CHECK_RESULT]#主界面
...
class HARDWAREBASEMSG:
    ...
    MSG_MOTOR_X_ARRIVE = [0x01, 0x02, 0x01, 0x33, 0x00, 0x00, 0x00]

    MSG_MOTOR_Y_ARRIVE = [0x01, 0x02, 0x02, 0x33, 0x00, 0x00, 0x00]

    MSG_X_XIANWEI = [0x01, 0x02, 0x01, 0x22, 0x00, 0x00, 0x00]

    MSG_Y_XIANWEI = [0x01, 0x02, 0x02, 0x22, 0x00, 0x00, 0x00]

    MSG_OPEN_LIGHT1 = [0x01, 0x03, 0x04, 0x01, 0x00, 0x00, 0x00]

    MSG_OPEN_LIGHT2 = [0x01, 0x03, 0x04, 0x02, 0x00, 0x00, 0x00]

    MSG_OPEN_ALL_LIGHT = [0x01, 0x03, 0x04, 0x03, 0x00, 0x00, 0x00]

    MSG_CLOSE_ALL_LIGHT = [0x01, 0x03, 0x04, 0x00, 0x00, 0x00, 0x00]

    MSG_GUANGSHAN = [0X01, 0x03, 0x08, 0x00, 0x00, 0x00, 0x00] #光栅信号，当接收到这个要做出反应
    ...
    MSG_REC_START = [0x01, 0x02, 0x01, 0x44, 0x00, 0x00, 0x00]

    MSG_REC_START1 = [0x01, 0x02, 0x01, 0x45, 0x00, 0x00, 0x00]#因控制那里自己预留一个判断，所以导致有两种判断，后面注释掉


    MSG_DUIWEI_SHENG = [0x01, 0x03, 0x05, 0x01, 0x00, 0x00, 0x00]

    MSG_DUIWEI_JIANG = [0x01, 0x03, 0x05, 0x02, 0x00, 0x00, 0x00]
    ...
    MSG_MOTOR_Z_MOVE = [0x01, 0x02, 0x03, 0x01, 0x00, 0x00, 0x00]
    ...
    MSG_LEFT_JIAJIN_DAOWEI = [0x01, 0x02, 0x01, 0x15, 0x00, 0x00, 0x00 ]

    MSG_RIGHT_JIAJIN_DAOWEI = [0x01, 0x02, 0x01, 0x13, 0x00, 0x00, 0x00 ]

    MSG_LEFT_JIAJIN_SONGKAI_DAOWEI = [0x01, 0x02, 0x01, 0x14, 0x00, 0x00, 0x00]

    MSG_RIGHT_JIAJIN_SONGKAI_DAOWEI = [0x01, 0x02, 0x01, 0x16, 0x00, 0x00, 0x00]

    MSG_LEFT_DUIWEI_DAOWEI = [0x01, 0x02, 0x01, 0x12, 0x00, 0x00, 0x00 ]

    MSG_RIGHT_RIGHT_DAOWEI = [0x01, 0x02, 0x01, 0x10, 0x00, 0x00, 0x00 ]

    MSG_LEFT_DUIWEI_SONGKAI_DAOWEI = [0x01, 0x02, 0x01, 0x09, 0x00, 0x00, 0x00 ]

    MSG_RIGHT_DUIWEI_SONGKAI_DAOWEI = [0x01, 0x02, 0x01, 0x11, 0x00, 0x00, 0x00 ]
